...
@mcp.tool()
def create_customer(name: str, email: str, phone: str = None, date_of_birth: str = None) -> Dict[str, Any]:
    """
...
@mcp.tool()
def get_spending_summary(customer_id: int, months: int = 6) -> Dict[str, Any]:
    """
...
@mcp.tool()
def get_financial_goals(customer_id: int, status: str = None) -> Dict[str, Any]:
    """
...
@mcp.tool()
def update_goal_progress(goal_id: int, current_amount: float) -> Dict[str, Any]:
    """
...
@mcp.tool()
def get_spending_categories() -> Dict[str, Any]:
    """
